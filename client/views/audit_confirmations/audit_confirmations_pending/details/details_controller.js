this.AuditConfirmationsAuditConfirmationsPendingDetailsController = RouteController.extend({
	template: "AuditConfirmations",
	

	yieldTemplates: {
		'AuditConfirmationsAuditConfirmationsPendingDetails': { to: 'AuditConfirmationsSubcontent'}
