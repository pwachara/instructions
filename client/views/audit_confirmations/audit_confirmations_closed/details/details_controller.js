this.AuditConfirmationsAuditConfirmationsClosedDetailsController = RouteController.extend({
	template: "AuditConfirmations",
	

	yieldTemplates: {
		'AuditConfirmationsAuditConfirmationsClosedDetails': { to: 'AuditConfirmationsSubcontent'}
