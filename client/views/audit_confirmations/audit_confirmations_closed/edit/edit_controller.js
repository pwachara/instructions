this.AuditConfirmationsAuditConfirmationsClosedEditController = RouteController.extend({
	template: "AuditConfirmations",
	

	yieldTemplates: {
		'AuditConfirmationsAuditConfirmationsClosedEdit': { to: 'AuditConfirmationsSubcontent'}
